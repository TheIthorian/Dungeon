...
class ADJECTIVES:
    ENEMY_IS_RARE_ADJECTIVES = {"animal": ["aggressive", "threatening", "ravenous", "slavering", "rabid"],
                                "humanoid": ["insane", "hallucinating", "zealous", "manic"],
                                "undead": ["hungering", "restless", "eerie", "lumbering", "shambling"]}
    ENEMY_IS_BOSS_ADJECTIVES = {"animal": ["monstrous", "gargantuan", "colossal"],
                                "humanoid": ["villainous", "murderous", "flagellating", "barbaric"],
                                "undead": ["necromantic", "sanguine", "hulking", "towering"]}
    ATTIRE_ADJECTIVES = {"low_psd_low_dfc": ["rusty", "torn", "broken", "ancient", "orcish"],
                         "low_psd_high_dfc": ["heavy", "functional", "plated", "dwarven", "resilient"],
                         "high_psd_low_dfc": ["appealing", "shiny", "delicate", "engraved", "embossed"],
                         "high_psd_high_dfc": ["lordly", "masterful", "heroic", "glorious", "magisterial"]}
    WEAPON_ADJECTIVES = {"low_atk_low_dmg": ["rusty", "battered", "broken", "crumbling", "orcish"],
                         "low_atk_high_dmg": ["heavy", "weighty", "large", "dwarven", "powerful"],
                         "high_atk_low_dmg": ["lightweight", "delicate", "nimble", "agile", "well-balanced"],
                         "high_atk_high_dmg": ["masterwork", "lordly", "elven", "heroic", "legendary"]}
    CONSUMABLE_ADJECTIVES = {"low_health": ["mouldy", "smelly", "suspicious", "repellent", "gross"],
